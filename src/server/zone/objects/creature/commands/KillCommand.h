...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
      ...
      if (targetObject->isPlayerCreature() || targetObject->isPet()) { /// para no usarse en jugadores o pets
				creature->sendSystemMessage("Error. Use /killplayer command to kill a player or a pet.");
