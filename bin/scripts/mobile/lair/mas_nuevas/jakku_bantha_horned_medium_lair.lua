jakku_bantha_horned_medium_lair = Lair:new {
	mobiles = {{"bantha_horned_male",1},{"bantha_horned_female",2}},
	spawnLimit = 12,
...
addLairTemplate("jakku_bantha_horned_medium_lair", jakku_bantha_horned_medium_lair)
