...
includeFile("conversations/record_keepers/record_keeper_senate_conv.lua")
...
includeFile("conversations/misc/despolo.lua")
...
-------------
------------
includeFile("conversations/nuevas/jaina_conv.lua") ---- Mis quest Jaina solo
----
includeFile("conversations/nuevas/echotrooper1_conv.lua") -- Para entrar en Echo Base
includeFile("conversations/nuevas/echotrooper2_conv.lua") -- Para salir de la Echo Base
-----
---- Caza de Bestias en Kaas --
...
--
-- includeFile("conversations/dungeon/archaeologist_leader.lua") -- Todavia no activa
---
