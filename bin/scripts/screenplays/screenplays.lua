...
---
includeFile("cities/moraband_valley.lua") -- nuevo
includeFile("cities/hutta_bilbousa_city.lua") -- nuevo
...
includeFile("static_spawns/moraband_static_spawns.lua")
includeFile("static_spawns/moraband_loot_containers1.lua") -- Containerloot de Templo Massassi
includeFile("static_spawns/moraband_loot_containers2.lua") -- Containerloot de Prision Arden
includeFile("static_spawns/mandalore_static_spawns.lua")
--
--includeFile("static_spawns/hoth_static_spawns.lua")

-- Jakku
includeFile("static_spawns/jakku_static_spawns.lua")
includeFile("jakku/jakku_battle_boundary.lua")
includeFile("jakku/jakku_battle_spawns.lua")
includeFile("jakku/jakku_weapons_facility.lua")
includeFile("jakku/jakku_weapons_facility_boss_1.lua")
includeFile("jakku/jakku_weapons_facility_boss_2.lua")
includeFile("jakku/jakku_weapons_facility_boss_3.lua")
includeFile("jakku/jakku_weapons_facility_boss_4.lua")
includeFile("jakku/jakku_weapons_facility_boss_5.lua")
includeFile("jakku/jakku_weapons_facility_boss_6.lua")
includeFile("jakku/jakku_overseer.lua")

-- Chandrila
includeFile("chandrila/chandrila_hanna_city.lua")
includeFile("chandrila/chandrila_nayli_outpost.lua")
includeFile("chandrila/chandrila_chandriltech_facility.lua")
--includeFile("static_spawns/chandrila_static_spawns.lua") -- Mi modelo antiguo
...
--------------
---- Jaina Quest ----
includeFile("nuevas/jaina.lua")
---------------


---- ECHO BASE ---
--- Entrar en Echo base
includeFile("hoth/echotrooper1.lua") --- Entrada a Echo base
---- Salir de la Echo Base
includeFile("hoth/echotrooper2.lua") --- Entrada a Echo base
------
includeFile("hoth/echo_base_ElevatorMenuComponent.lua")
includeFile("hoth/echo_base_elevators.lua")
