...
function MorabandValleyScreenPlay:spawnMobiles()
  ...
  local pNpc = spawnMobile("moraband", "commoner", 60, -0.5, 0.4, -4.6, 33, 42000384)
    self:setMoodString(pNpc, "npc_sitting_chair")

    pNpc = spawnMobile("moraband", "commoner", 60, -0.6, 0.4, -1.4, 142, 42000384)
    self:setMoodString(pNpc, "npc_sitting_chair")

    pNpc = spawnMobile("moraband", "commoner", 60, 5.1, 0.4, -4.6, -14, 42000384)
    self:setMoodString(pNpc, "npc_sitting_chair")

    pNpc = spawnMobile("moraband", "commoner", 60, -4.0, 0.4, -7.2, -47, 42000384)
    self:setMoodString(pNpc, "conversation")

    pNpc = spawnMobile("moraband", "commoner", 60, -6.8, 0.4, -4.3, 133, 42000384)
    self:setMoodString(pNpc, "conversation")

    pNpc = spawnMobile("moraband", "commoner", 60, -8.7, 1.0, 9.7, 119, 42000385)
    self:setMoodString(pNpc, "npc_sitting_chair")

    pNpc = spawnMobile("moraband", "commoner", 60, -6.5, 1.0, 7.6, -49, 42000385)
