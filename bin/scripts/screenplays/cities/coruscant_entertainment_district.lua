...
-- Entertainment District Sports Bar Cantina
  ...
  spawnSceneObject("coruscant", "object/tangible/gambling/wheel/roulette.iff", -4.8, -0.7, -8.6, 37000714, math.rad(0) )
	spawnSceneObject("coruscant", "object/tangible/gambling/slot/standard.iff", -8, -0.7, -10.4, 37000714, math.rad(90) )
	spawnSceneObject("coruscant", "object/tangible/gambling/slot/standard.iff", 8, -0.7, -10.4, 37000714, math.rad(-90) )

	spawnSceneObject("coruscant", "object/tangible/microphone/microphone.iff", 0.1, 0, -11, 37000714, math.rad(0) )
  spawnSceneObject("coruscant", "object/tangible/instrument/nalargon.iff", -0.1, 0, -15.7, 37000714, math.rad(0) )
...
function CoruscantEntertainmentScreenPlay:spawnMobiles()
	...
	spawnMobile("coruscant", "trainer_imagedesigner", 10, -4.7, 0.6, -6.4, 32, 37000718)
...
--  AiAgent(pNpc):setAiTemplate("idlewander")
 ...
 -- AiAgent(pNpc):setAiTemplate("idlewander")
  ...
  --  Cantinas
  pNpc = spawnMobile("coruscant", "bartender", 60, 0.3, 0.3, 4.4, 176, 37000721)
	self:setMoodString(pNpc, "entertained")
  --
  pNpc = spawnMobile("coruscant", "bartender", 60, 0.3, 0.3, 4.4, 176, 37000714)
	self:setMoodString(pNpc, "conversation")

  pNpc = spawnMobile("coruscant", "bartender", 60, 0.3, 0.3, 4.4, 176, 37000316)
	self:setMoodString(pNpc, "happy")
...
--------- DINER -------
 ...
 self:setMoodString(pNpc, "angry")
  ...
  spawnMobile("coruscant", "stormtrooper", 60, 0.2, 0.3, 3.2, 0, 37000570)
  spawnMobile("coruscant", "stormtrooper", 60, 4.6, 0.3, -1.1, -25, 37000570)

  spawnMobile("coruscant", "imperial_first_lieutenant", 60, -4.3, 0.3, -4.3, 90, 37000571)

  spawnMobile("coruscant", "stormtrooper", 60, 5.6, -6.8, -5.1, -7, 37000573)
  spawnMobile("coruscant", "stormtrooper", 60, 2.8, -6.8, -5.8, 0, 37000573)

  spawnMobile("coruscant", "stormtrooper", 60, -2.6, -13.7, -9.6, 0, 37000575)
  spawnMobile("coruscant", "stormtrooper", 60, -5.8, -13.7, -4.2, 0, 37000575)
  spawnMobile("coruscant", "stormtrooper", 60, -1.8, -13.7, 0.6, 0, 37000575)

  spawnMobile("coruscant", "stormtrooper", 60, -3.1, -13.8, 11.9, 0, 37000576)
  spawnMobile("coruscant", "stormtrooper", 60, 4.5, -13.8, 12.6, -90, 37000576)

  spawnMobile("coruscant", "stormtrooper", 60, 17, -13.8, 11.6, -125, 37000577)
  spawnMobile("coruscant", "stormtrooper", 60, 15.5, -13.8, 6.8, 10, 37000577)

  spawnMobile("coruscant", "stormtrooper", 60, 14.5, -13.8, -7.6, 157, 37000578)
  spawnMobile("coruscant", "stormtrooper", 60, 15.7, -13.8, -13.6, -5, 37000578)

  spawnMobile("coruscant", "fbase_stormtrooper_medic_hard", 60, 14.8, -11.5, -20.8, -11, 37000578)
-------------------------------------------------
