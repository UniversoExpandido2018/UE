...
function kaas_rebel_cave:spawnSceneObjects()
 ...
 -- spawnSceneObject("kaas", "object/building/player/city/shuttleport_corellia.iff", 2852.3, 125.6, 3900, 0, math.rad(180) ) --- No anyadir este shuttleport
-- spawnSceneObject("coruscant", "object/building/player/city/shuttleport_corellia.iff", -5816, 0, -4833, 0, math.rad(180) ) --- Anyadido a snapshot
