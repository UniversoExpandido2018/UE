...
grievous_speeder_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_grievous_wheel_bike.iff"
}
ObjectTemplates:addClientTemplate(grievous_speeder_pcd, "object/intangible/vehicle/shared_grievous_wheel_bike.iff")
-----

air_swoop_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_air2_swoop_speeder_pcd.iff"
}
ObjectTemplates:addClientTemplate(air_swoop_pcd, "object/intangible/vehicle/shared_air2_swoop_speeder_pcd.iff")
---------------

xj6_air_speeder_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_xj6_air_speeder_pcd.iff"
}
ObjectTemplates:addClientTemplate(xj6_air_speeder_pcd, "object/intangible/vehicle/shared_xj6_air_speeder_pcd.iff")
------------------

jetpack2_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_tcg_hk47_jetpack_pcd.iff"
}
ObjectTemplates:addClientTemplate(jetpack2_pcd, "object/intangible/vehicle/shared_tcg_hk47_jetpack_pcd.iff")
------------------
