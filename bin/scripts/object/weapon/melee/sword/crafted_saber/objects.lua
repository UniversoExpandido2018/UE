...
super_saber = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/melee/sword/crafted_saber/shared_sword_lightsaber_one_handed_s3_gen4.iff"
}

ObjectTemplates:addClientTemplate(super_saber, "object/weapon/melee/sword/crafted_saber/shared_sword_lightsaber_one_handed_s3_gen4.iff")
