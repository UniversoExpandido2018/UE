...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_infiltrator_armor_infiltrator_s01_bicep_r, "object/tangible/wearables/armor/infiltrator/shared_armor_infiltrator_s01_bicep_r.iff")
