...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_infiltrator_armor_infiltrator_s01_boots, "object/tangible/wearables/armor/infiltrator/shared_armor_infiltrator_s01_boots.iff")
