...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_assault_armor_rebel_assault_boots_gcw, "object/tangible/wearables/armor/rebel_assault/shared_armor_rebel_assault_boots_gcw.iff")
