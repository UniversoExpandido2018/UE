...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_battle_armor_rebel_battle_chest_plate_gcw, "object/tangible/wearables/armor/rebel_battle/shared_armor_rebel_battle_chest_plate_gcw.iff")
