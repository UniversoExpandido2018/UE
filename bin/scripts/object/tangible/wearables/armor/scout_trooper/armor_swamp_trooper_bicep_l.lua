...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_scout_trooper_armor_swamp_trooper_bicep_l, "object/tangible/wearables/armor/scout_trooper/shared_armor_swamp_trooper_bicep_l.iff")
