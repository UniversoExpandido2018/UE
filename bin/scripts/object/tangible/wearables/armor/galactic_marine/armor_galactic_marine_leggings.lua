...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_leggings, "object/tangible/wearables/armor/galactic_marine/shared_armor_galactic_marine_leggings.iff")
