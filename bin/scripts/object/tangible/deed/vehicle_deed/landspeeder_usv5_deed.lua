object_tangible_deed_vehicle_deed_landspeeder_usv5_deed = object_tangible_deed_vehicle_deed_shared_landspeeder_usv5_deed:new {
	...
	controlDeviceObjectTemplate = "object/intangible/vehicle/shared_landspeeder_usv5_pcd.iff",
	generatedObjectTemplate = "object/mobile/vehicle/shared_landspeeder_usv5.iff",
