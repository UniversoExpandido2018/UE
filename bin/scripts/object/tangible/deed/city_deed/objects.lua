...
-----------------
--- Diner Deed ---
object_tangible_deed_city_deed_shared_diner_deed = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/player_house_deed/shared_diner_house_deed.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_deed_city_deed_shared_diner_deed, "object/tangible/deed/player_house_deed/shared_diner_house_deed.iff")
