...
object_tangible_deed_player_house_deed_vipbunker_house_deed = object_tangible_deed_player_house_deed_shared_vipbunker_house_deed:new {
	...
	generatedObjectTemplate = "object/building/player/shared_vipbunker_house.iff",
...
ObjectTemplates:addTemplate(object_tangible_deed_player_house_deed_vipbunker_house_deed, "object/tangible/deed/player_house_deed/shared_vipbunker_house_deed.iff")
