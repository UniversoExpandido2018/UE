...
starter_house = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/player/shared_naboo_small_window_s01.iff"
}
ObjectTemplates:addClientTemplate(starter_house, "object/building/player/shared_naboo_small_window_s01.iff")
