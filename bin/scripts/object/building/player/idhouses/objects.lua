...
-- Diner para jugadores ---
diner_player = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/player/shared_player_diner.iff"
}
ObjectTemplates:addClientTemplate(diner_player, "object/building/player/shared_player_diner.iff")
------------

-- Diner para Coruscant --
object_building_player_shared_player_diner = SharedBuildingObjectTemplate:new {
  clientTemplateFileName = "object/building/player/city/shared_diner_no_planet_restriction.iff"
}
ObjectTemplates:addClientTemplate(object_building_player_shared_player_diner, "object/building/player/city/shared_diner_no_planet_restriction.iff")
