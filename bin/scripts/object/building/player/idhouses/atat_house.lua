...
--			{templateFile = "object/tangible/sign/player/house_address.iff", x = 4.34, z = 3.4, y = 18.40, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/house_address.iff", x = 3.34, z = 5.1, y = 18.44, ox = 0, oy = 0.157107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
			{templateFile = "object/static/structure/general/streetlamp_large_blue_style_02_on.iff", x = 3.34, z = 0, y = 15.44, ox = 0, oy = -0.207107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
...
ObjectTemplates:addTemplate(object_building_player_atat_house, "object/building/player/shared_atat_house.iff")
