...
---- Kaas Enclave ----
kaas_enclave = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/general/shared_kaas_enclave.iff"
}
ObjectTemplates:addClientTemplate(kaas_enclave, "object/building/general/shared_kaas_enclave.iff")
------------------

---- coruscant Enclave ----
coruscant_enclave = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/general/shared_coruscant_enclave.iff"
}
ObjectTemplates:addClientTemplate(coruscant_enclave, "object/building/general/shared_coruscant_enclave.iff")
------------------
