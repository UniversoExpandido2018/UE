...
object_tangible_deed_vehicle_deed_atst_deed = object_tangible_deed_vehicle_deed_shared_atst_deed:new {
	...
	controlDeviceObjectTemplate = "object/intangible/vehicle/walker_at_st_pcd.iff",
...
ObjectTemplates:addTemplate(object_tangible_deed_vehicle_deed_atst_deed, "vehicle_atst_deed.iff")
