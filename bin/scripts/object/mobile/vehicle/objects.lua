...
grievous_speeder = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/shared_grievous_wheel_bike.iff"
}
ObjectTemplates:addClientTemplate(grievous_speeder, "object/mobile/vehicle/shared_grievous_wheel_bike.iff")
-----

air_swoop = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/shared_air2_swoop_speeder.iff"
}
ObjectTemplates:addClientTemplate(air_swoop, "object/mobile/vehicle/shared_air2_swoop_speeder.iff")
----------

xj6_air_speeder = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/shared_xj6_air_speeder.iff"
}
ObjectTemplates:addClientTemplate(xj6_air_speeder, "object/mobile/vehicle/shared_xj6_air_speeder.iff")
-------------

jetpack2 = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/shared_tcg_hk47_jetpack.iff"
}
ObjectTemplates:addClientTemplate(jetpack2, "object/mobile/vehicle/shared_tcg_hk47_jetpack.iff")
-------------
