...
object_draft_schematic_structure_commando_house_schem = object_draft_schematic_structure_shared_commando_house_schem:new {
 ...
 --  customObjectName = "Deed for: VIP Bunker",
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/shared_commando_house_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_commando_house_schem, "object/draft_schematic/structure/shared_commando_house_schem.iff")
