...
object_draft_schematic_structure_tree_house_schem = object_draft_schematic_structure_shared_tree_house_schem:new {
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/shared_tree_house_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_tree_house_schem, "object/draft_schematic/structure/shared_tree_house_schem.iff")
