...
object_draft_schematic_structure_nab_sm_win_01_schem = object_draft_schematic_structure_shared_nab_sm_win_01_schem:new {
 ...
 --  customObjectName = "Deed for: VIP Bunker",
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/shared_naboo_small_window_s01_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_nab_sm_win_01_schem, "object/draft_schematic/structure/shared_nab_sm_win_01_schem.iff")
