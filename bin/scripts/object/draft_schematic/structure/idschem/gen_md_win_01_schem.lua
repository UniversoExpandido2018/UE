...
object_draft_schematic_structure_gen_md_win_01_schem = object_draft_schematic_structure_shared_gen_md_win_01_schem:new {
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/shared_generic_medium_window_s01_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_gen_md_win_01_schem, "object/draft_schematic/structure/shared_gen_md_win_01_schem.iff")
