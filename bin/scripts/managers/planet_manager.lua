...
dathomir = {
	...
	planetObjects = {
		...
		--{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0.314904, oz = 0, ow = 0.949123, x = 5289.6, z = 78.5, y = -4146.1, parentid = 0}
		  {templateFile = "terminal_jedi_unlock.iff", ox = 0, oy = 1, oz = 0, ow = 0.512705, x = 5303.53, z = 78.50, y = -4143.36, parentid = 0} --Terminal para desbloquear jedi
	}
}
...
taanab = {
	...
	badgeAreas = { --No funcionan las badges
...
jakku = {
		...
		planetTravelPoints = {
	{name = "Cratertown", x = 4223, z = 9.75, y = -5142, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
...
moraband = {
  ...
  planetTravelPoints = {
    ...
    badgeAreas = {},
		...
		planetObjects = {
	--		{templateFile = "object/tangible/terminal/terminal_mission.iff", ox = 0, oy = 0, oz = 0, ow = 0.708587, x = -1726.4, z = 91.0, y = -679.7, parentid = 0} --terminal de mission
		}
}
...
chandrila = {
  ...
  planetTravelPoints = {
    ...
    badgeAreas = {
  --  {"chandrila_mon_mothma_house",2469,2307,30,156},
  --  {"chandrila_jedi_tomb",4339,-4287,30,157},
  --  {"chandrila_state_park",-5013,4089,30,158},
  },
}
...
--    {name = "a Smuggler Outpost", x = 2852, z = 125, y = 3896, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1}, -- Aqui no hay nada en el mapa
    },
  ...
  planetTravelPoints = {
		---- viejas ---
--		{name = "Coruscant Spaceport", x = -119, z = 40, y = 3132, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
--    {name = "Spaceport District Shuttle", x = -14, z = 40, y = 3203, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
--		{name = "Collective Commerce District Shuttleport", x = -1866, z = 40, y = -176, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
--		{name = "Monument Square Shuttleport", x = 1538, z = 40, y = 793, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
--		{name = "Entertainment District Shuttleport", x = 2251, z = 0, y = -4567, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
