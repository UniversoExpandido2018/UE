...
factionList = {
	{ "rebel", true, "imperial,prophets,dark_jedi", "light_jedi", 1.0 },
	{ "imperial", true, "rebel,light_jedi", "dark_jedi,prophets", 1.0 },
	...
	{ "pirate", true, "arden_industries", "", 1.0 },
	...
	{ "thug", true, "townsperson,arden_industries", "", 1.0 },
	...
	-------- NUEVAS FACCIONES ------
	{ "light_jedi", true, "sith_shadow,dark_jedi,imperial,prophets", "rebel", 1.0 },
	{ "dark_jedi", true, "light_jedi,rebel,arden_industries", "imperial,prophets", 1.0 },
	{ "arden_industries", true, "dark_jedi,pirate,thug", "imperial,rebel", 1.0 },
	{ "prophets", true, "rebel,light_jedi", "imperial,dark_jedi", 1.0 },
}
